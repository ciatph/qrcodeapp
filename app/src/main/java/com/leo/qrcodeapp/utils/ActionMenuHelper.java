...
public enum ActionMenuHelper {
    ...
    public int [] SCREEN_FARMERLIST_ENABLED_ICONS = { R.id.action_app_add, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };
    ...
    public int[] SCREEN_PLOTLIST_DISABLED_ICONS = { R.id.action_app_save, R.id.action_app_cancel, R.id.action_app_delete, R.id.action_app_edit, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };

    // action icon set for Add new data
    public int [] SCREEN_CREATE_ENABLED_ICONS = { R.id.action_app_save, R.id.action_app_cancel };
    public int[] SCREEN_CREATE_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_delete, R.id.action_app_edit,  R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };

    // action icon set for Edit data
    public int [] SCREEN_EDIT_ENABLED_ICONS = { R.id.action_app_save, R.id.action_app_cancel };
    public int[] SCREEN_EDIT_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_edit, R.id.action_app_delete, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };
    ...
    public int[] SCREEN_VIEW_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };
    ...
    public int[] SCREEN_VIEW_TOSYNC_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_filter,  R.id.action_app_delete, R.id.action_app_upload, R.id.action_app_search };
    ...
    public int[] SCREEN_VIEW_NETERR_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };
    ...
    public int[] SCREEN_VIEW_NETERR_TOSYNC_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_filter, R.id.action_app_delete, R.id.action_app_upload, R.id.action_app_search };

    // action icon set for View (Firebase saved) data
    public int [] SCREEN_VIEW_SYNCED_ENABLED_ICONS = { R.id.action_app_cancel };
    public int[] SCREEN_VIEW_SYNCED_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_delete, R.id.action_app_edit, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };
    ...
    public int[] SCREEN_PLOT_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };

    // action icon set for Plot view pages unsynced
    public int [] SCREEN_PLOT_UNSYNCED_ENABLED_ICONS = { R.id.action_app_edit,  R.id.action_app_cancel, R.id.action_app_delete,  R.id.action_app_filter };
    public int[] SCREEN_PLOT_UNSYNCED_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };

    // action icon set for Standalone pages
    public int [] SCREEN_SOLO_ENABLED_ICONS = { R.id.action_app_cancel };
    public int[] SCREEN_SOLO_DISABLED_ICONS = { R.id.action_app_add, R.id.action_app_save, R.id.action_app_delete, R.id.action_app_edit, R.id.action_app_filter, R.id.action_app_upload, R.id.action_app_search };
}
